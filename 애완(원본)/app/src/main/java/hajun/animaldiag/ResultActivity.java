...
public class ResultActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		double[] dPattern = m_share.GetSelectedSymptom();

		m_share.m_hanbang.Diagnosis(dPattern, m_share.m_nDisease);
		int[] nIdx = m_share.m_hanbang.GetResult();
	...
	public void DisplayResult()
	{
		...
		{
			final int nIdx = i;
			String strPer = String.format("%.2f%%", 100-(m_dDist[i]/m_dDist[m_share.m_nDisease-1]*100));
